...
require_once dirname(__FILE__).'/../lib/Basecre8GMapPluginActions.class.php';

/**
 * cre8GMapPlugin actions.
 * 
 * @package    cre8GMapPlugin
 * @subpackage cre8GMapPlugin
 * @author     Bogumil Wrona <b.wrona@cre8newmedia.com>
 * @version    SVN: $Id: actions.class.php 12534 2008-11-01 13:38:27Z Kris.Wallsmith $
 */
class cre8GMapPluginActions extends Basecre8GMapPluginActions
{
  ...
  public function executeSample3()
  {
    ...
    $gMapIcon = new GMapIcon(
      'nice_icon',
      '/cre8GMapPlugin/images/nice_icon.png',
      array(
        'width'=>18,
        'height'=>25,
  ...
  public function executeSample6(sfWebRequest $request)
  {
    $this->venueLocation = sfConfig::get('app_cre8_ordering_system_venue_location');
    $this->getResponse()->addJavascript('http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=false&amp;key=' . GMap::guessAPIKey(), 'last');
